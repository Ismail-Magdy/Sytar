...
class AddGradesBottomSheet extends StatefulWidget {
  ...
  const AddGradesBottomSheet({super.key, required this.subject});
          ...
          children: [
            ...
            if (widget.subject.midterm1Total != null &&
              ...
              CustomTextFormField(
                ...
                hintText: "ميدتيرم أول (من ${widget.subject.midterm1Total})",
            ...
            if (widget.subject.midterm2Total != null &&
              ...
              CustomTextFormField(
                ...
                hintText:
                    "ميدتيرم تاني أو عملي (من ${widget.subject.midterm2Total})",
                keyboardType: TextInputType.number,
                validator: (val) =>
